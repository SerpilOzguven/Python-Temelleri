...
class Window(QtWidgets.QMainWindow):
    ...
    def editStudent(self):
        ...
        if item is not None:
            text, ok = QInputDialog.getText(self,"Edit Student", "Edit Name", QLineEdit.Normal, item.text())
    ...
    def removeStudent(self):
        ...
        q = QMessageBox.question(self, "Remove Student", "Do uou want to remove student :" + item.text(), QMessageBox.Yes | QMessageBox.No)
